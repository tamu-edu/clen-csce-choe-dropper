...
# one hidden layer.
#
# function [gene_pool,gen_err,min_net] = ga(params)
#
...
for i=1:n_individuals
   ...
   for k=1:params.num_drops
	...
	while (1) 
		...
		input = [activate(params.arena_size,params.num_rays,loc,m,balls);-1]';
		
		#--------------------
		# simple network activation
		#--------------------
		hidden = tanh(input*gene_pool(i).input_to_hidden);
